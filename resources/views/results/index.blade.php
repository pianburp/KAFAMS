        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="border px-4 py-2">
                    <a href="{{ route('manageResult.edit', $result) }}" class="text-white hover:text-blue-700">Edit</a>

                    <form method="POST" action="{{ route('manageResult.delete', $result) }}" style="display: inline;" onsubmit="return confirm('Are you sure?');">
                        @csrf
                        @method('DELETE')
